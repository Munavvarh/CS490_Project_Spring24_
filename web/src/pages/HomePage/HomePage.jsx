      ...
      <main className="home-main">
        ...
        <section id="quick-start" className="home-section">
          ...
          <div className="home-section-text">
            <p>
              Getting started with SyntaxSwitch is simple and straightforward. Here’s how you can begin translating your code in just a few clicks:
            </p>
            <ol className="list-decimal list-inside">
              <li><strong>Access the Tool</strong>: Click on the 'Translator Tool' button located in the navigation bar to access the main translation interface.</li>
              <li><strong>Select Languages</strong>: Use the dropdown menus to choose the source language of your code and the target language to which you want it converted.</li>
