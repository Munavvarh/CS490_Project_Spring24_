        ...
        <main className="home-main">
          <section id="overview" className="home-section">
            ...
            <p className="home-section-text">
              ...
              bridge the gap between different programming languages seamlessly.
              Leveraging the powerful GPT-3 API, it assists developers by
              converting code snippets, functions from one language to another
              with high accuracy. Whether you're dealing with legacy code,
              integrating with codebases in different languages, or simply
              curious to see how your code would look in another syntax,
              SyntaxSwitch makes the process intuitive and error-free. With our
              tool, you can ensure code correctness and save countless hours of
              manual translation.
            </p>
          </section>
          <section id="quick-start" className="home-section">
            ...
            <div className="home-section-text">
              <p>
                Getting started with SyntaxSwitch is simple and straightforward.
                Here’s how you can begin translating your code in just a few
                clicks:
              </p>
              <br />
              <ol className="list-inside list-decimal">
                <li>
                  ...
                  Tool' button located in the navigation bar to access the main
                ...
                <li>
                  <strong>Paste Your Code</strong>: In the code submission box,
                  paste the code you wish to translate.
                </li>
                <li>
                  <strong>Translate</strong>: Hit the 'Submit' button and watch
                  as SyntaxSwitch translates your code efficiently.
                </li>
                <li>
                ...
                <li>
                  ...
                  GPT-3 API directly from our 'API Status' button to ensure the
                  translation service is online.
                </li>
                <li>
                  <strong>Documentation</strong>: Access comprehensive guides
                  and tutorials via the 'Documentation' button to help you make
                ...
                <li>
                  <strong>Feedback</strong>: Your input is invaluable to us. The
                  'Feedback' button on the navigation bar is your direct line to
                  our development team. Whether you've encountered a bug, have
                  suggestions for new features, or want to leave general
                  comments, we're all ears. We strive to consider all user
                  suggestions and work diligently to enhance your experience.
                </li>
              </ol>
            </div>
          </section>
